<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="SaleOrder.aspx.cs" Inherits="SAShahBiltySystem.SaleOrder" %>
                ...
                <div class="col-md-12">
                        ...
                        <div class="block">
                            ...
                            <div class="block-title">
                                <h2><strong>Sale Order</strong></h2>
                            </div>
                            ...
                            <asp:Panel ID="pnlmain" runat="server">
                               <asp:Panel ID="pnl1" runat="server">
                                   <table style="width: 100%">
                                    <tr>
                                    <td style="width: 3%"></td>
                                    <td style="width: 30%"><asp:DropDownList ID="ddlcustomer" ClientIDMode="Static" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlcustomer_SelectedIndexChanged"></asp:DropDownList></td>
                                    <td style="width: 2%"></td>
                                    <td style="width: 30%"><asp:TextBox ID="txtmobile" runat="server" CssClass="form-control" placeholder="Mobile No"></asp:TextBox></td>
                                    <td style="width: 2%"></td>
                                    <td style="width: 30%"><asp:TextBox ID="txtemail" runat="server" CssClass="form-control" placeholder="Email"></asp:TextBox></td>
                                    <td style="width: 3%"></td>
                                    </tr>
                                    </table>
                                   <table style="width: 100%; margin-top: 1%; margin-bottom: 1%">
                                    <tr>
                                    <td style="width: 3%"></td>
                                    <td style="width: 30%"><asp:DropDownList ID="ddlcourier" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlcourier_SelectedIndexChanged"></asp:DropDownList></td>
                                    <td style="width: 2%"></td>
                                    <td style="width: 30%"><asp:TextBox ID="txtdeliverycharges" runat="server" TextMode="Number" CssClass="form-control" placeholder="Delivery Charges"></asp:TextBox></td>
                                    <td style="width: 2%"></td>
                                    <td style="width: 30%"><asp:TextBox ID="txtshippingaddress" runat="server" TextMode="MultiLine" CssClass="form-control" placeholder="Shipping Address"></asp:TextBox></td>
                                    <td style="width: 3%"></td>
                                    </tr>
                                   </table>
                                ...
                                <asp:Panel ID="pnlgrid" runat="server">
                                    ...
                                    <asp:GridView ID="gvSaleorderDetail" runat="server" Width="100%" CssClass="table table-striped table-vcenter" AutoPostBack="true" AutoGenerateColumns="false" OnRowCommand="gvSaleorderDetail_RowCommand" OnRowDeleting="gvSaleorderDetail_RowDeleting">
                                        <Columns>
                                ...
                                <asp:Panel ID="Panel1" runat="server">
                                    <asp:GridView ID="gvsaleorder" runat="server" Width="100%" CssClass="table table-striped table-vcenter" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="text-center" EmptyDataText="No Record Found" AutoGenerateColumns="false" OnRowCommand="gvsaleorder_RowCommand" OnRowDeleting="gvsaleorder_RowDeleting">
                                        <Columns>
                                            <asp:BoundField DataField="SaleOrderID" HeaderText="ID" />
                                            <asp:BoundField DataField="Code" HeaderText="Code" />
                                            <asp:BoundField DataField="CustomerName" HeaderText="Customer Name" />
                                            <asp:BoundField DataField="MobileNo" HeaderText="Mobile No" />
                                            <asp:BoundField DataField="Email" HeaderText="Email" />
                                            <asp:BoundField DataField="Name" HeaderText="Courier" />
                                            <asp:BoundField DataField="DeliveryChargesAmount" HeaderText="Delivery Charges" />
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header text-center">
                        <h5><asp:Label ID="lblModalTitle" runat="server" Text="Add New Customer"></asp:Label></h5>                       
                    </div>
                    <!-- END Modal Header -->
                    ...
                    <div class="modal-body">
                        <div class="form-horizontal form-bordered">
                            ...
                            <div class="form-group form-actions">
                                <table style="width: 100%">
                                <tr>
                                <td style="width: 50%"><asp:TextBox ID="txtcustCode" runat="server" CssClass="form-control" placeholder="Customer Code"></asp:TextBox></td>
                                <td style="width: 50%"><asp:TextBox ID="txtcustname" runat="server" CssClass="form-control" placeholder="Customer Name"></asp:TextBox></td>
                                </tr>
                                <tr>
                                <td style="width: 50%"><asp:TextBox ID="txtcustmobno" runat="server" TextMode="Number" CssClass="form-control" placeholder="Mobile No"></asp:TextBox></td>
                                <td style="width: 50%"><asp:TextBox ID="txtcustemail" runat="server" CssClass="form-control" placeholder="Email"></asp:TextBox></td>
                                </tr>
                                <tr>
                                <td style="width: 50%"><asp:TextBox ID="txtresiadd" runat="server" TextMode="MultiLine" CssClass="form-control" placeholder="Residential Address"></asp:TextBox></td>
                                <td style="width: 50%"><asp:TextBox ID="txtpostadd" runat="server" TextMode="MultiLine" CssClass="form-control" placeholder="Postal Address"></asp:TextBox></td>
                                </tr>
                                </table>
                            ...
                            <asp:LinkButton ID="lbsavecust" runat="server" CssClass="btn btn-sm btn-primary" OnClick="lbsavecust_Click"><i class="fas fa-save"></i> | Save</asp:LinkButton>
                                    <asp:LinkButton ID="lbcancelcust" runat="server" CssClass="btn btn-sm btn-danger" OnClick="lbcancelcust_Click"><i class="fas fa-times-circle"></i> | Cancel</asp:LinkButton>
