                ...
                try
                {
                    if (LoggedInData.Rows.Count > 0)
                    {
                        ...
                        try
                        {
                            ...
                            DataTable dtMainMenus = LoggedInData.Rows[0]["UserName"].ToString() == "SuperAdmin" ? dml.GetMainMenus() : dml.GetMainMenus(GroupID);
                            ...
                            if (dtMainMenus.Rows.Count > 0)
                            {
                                ...
                                {
                                    Int64 MenuID = Convert.ToInt64(dtMainMenus.Rows[i]["PermissionID"]);
                                   // string MenuIcon = dtMainMenus.Rows[i]["Icon"].ToString();
                                    ...
                                    if (LoggedInData.Rows[0]["UserName"].ToString() == "SuperAdmin")
                                    {
                                        ...
                                        if (dtSubMenues.Rows.Count > 0)
                                        {
                                            ...
                                            LeftSideBar.InnerHtml += "<li>";
                                            LeftSideBar.InnerHtml += "<a href=\"#\" class=\"sidebar-nav-menu\"><i class=\"fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide\"></i><i class=\" sidebar-nav-icon\"></i><span class=\"sidebar-nav-mini-hide\">" + dtMainMenus.Rows[i]["MenuName"].ToString() + "</span></a>";
                                        ...
                                        {
                                            LeftSideBar.InnerHtml += "<a href=\"index.html\" class=\" \"><i class=\" sidebar-nav-icon\"></i><span class=\"sidebar-nav-mini-hide\">" + dtMainMenus.Rows[i]["MenuName"].ToString() + "</span></a>";
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        //{
                                            ...
                                            LeftSideBar.InnerHtml += "<li>";
                                            LeftSideBar.InnerHtml += "<a href=\"#\" class=\"sidebar-nav-menu\"><i class=\"fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide\"></i><span class=\"sidebar-nav-mini-hide\">" + dtMainMenus.Rows[i]["Description"].ToString() + "</span></a>";
                                        LeftSideBar.InnerHtml += "<ul class=\"sub-menu\">";
                                        for (int j = 0; j < dtSubMenues.Rows.Count; j++)
                                        {
                                           // string SubmenuIcon = dtSubMenues.Rows[j]["icon"].ToString();
